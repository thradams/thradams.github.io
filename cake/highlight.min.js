    ...
    var e = (() =>
    {
        "use strict"; return e =>
        {
            const n = e.regex, t = e.COMMENT("//", "$", {
                ...
                keyword: ["typeid", "_Hashof" ,"try", "catch", "throw", "repeat", "defer", "asm", "auto", "break", "case", "continue", "default", "do", "else", "enum", "extern", "for", "fortran", "goto", "if", "inline", "register", "restrict", "return", "sizeof", "struct", "switch", "typedef", "union", "volatile", "while", "_Alignas", "_Alignof", "_Atomic", "_Generic", "_Noreturn", "_Static_assert", "_Thread_local", "alignas", "alignof", "noreturn", "static_assert", "static_debug", "static_state", "thread_local", "_Pragma", "_Move", "_View", "_Owner", "_Implicit", "_Obj_owner"],
