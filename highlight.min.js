    ...
    var e = (() =>
    {
        "use strict"; return e =>
        {
            const n = e.regex, t = e.COMMENT("//", "$", {
                ...
                keyword: ["typeid", "try", "catch", "throw", "repeat", "_Defer", "defer", "asm", "auto", "break", "case", "continue", "default", "do", "else", "enum", "extern", "for", "fortran", "goto", "if", "inline", "register", "restrict", "return", "sizeof", "struct", "switch", "typedef", "union", "volatile", "while", "_Alignas", "_Alignof", "_Atomic", "constexpr", "_Generic", "nullptr", "_Noreturn", "_Static_assert", "_Thread_local", "alignas", "alignof", "noreturn", "static_assert", "thread_local", "_Pragma", "_View", "_Opt", "_Out", "_Owner", "_Implicit", "_Obj_owner", "_Ctor", "_View", "_Dtor", "static_set", "static_state", "static_debug", "assert", "mutable"],
